...
<section class="text-gray-600 dark:text-gray-100 body-font relative">
    <div class="container px-5 py-3 mx-auto">
        <div class="flex flex-col text-center w-full mb-5">
            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4">Sign in</h1>
            <p class="text-sm dark:text-gray-200 mt-3">Dont have an account? <a href="register" class="text-primary-500 underline">Click here</a> to sign up.</p>
        </div>
